...
public class Room101Activity extends AppCompatActivity {
    ...
    // PLACEHOLDER FLAG - Will be replaced later
    private static final String CORRECT_FLAG = "test123";

    // Room Details
    private static final int ROOM_NUM = 101;
    private static final String GHOST_NAME = "The Phantom";
    ...
    private void handleCorrectFlag() {
        ...
        new Handler().postDelayed(() -> {
            Intent intent = new Intent(Room101Activity.this, CheckoutSuccessActivity.class);
