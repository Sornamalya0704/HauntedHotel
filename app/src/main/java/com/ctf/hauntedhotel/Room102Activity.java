...
public class Room102Activity extends AppCompatActivity {
    ...
    private static final int ROOM_NUM = 102;
    private static final String GHOST_NAME = "The Whisperer";
    ...
    private void handleCorrectFlag() {
        ...
        new Handler().postDelayed(() -> {
            Intent intent = new Intent(Room102Activity.this, CheckoutSuccessActivity.class);
