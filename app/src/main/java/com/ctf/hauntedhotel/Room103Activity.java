...
public class Room103Activity extends AppCompatActivity {
    ...
    private static final int ROOM_NUM = 103;
    private static final String GHOST_NAME = "The Shadow";
    ...
    private void handleCorrectFlag() {
        ...
        new Handler().postDelayed(() -> {
            Intent intent = new Intent(Room103Activity.this, CheckoutSuccessActivity.class);
