...
public class Room104Activity extends AppCompatActivity {
    ...
    private static final int ROOM_NUM = 104;
    private static final String GHOST_NAME = "The Mirror";
    ...
    private void handleCorrectFlag() {
        ...
        new Handler().postDelayed(() -> {
            Intent intent = new Intent(Room104Activity.this, CheckoutSuccessActivity.class);
